...
Route::group(['prefix' => 'admin', /*'middleware' => ['employee'],*/ 'as' => 'admin.' ], function () {
    ...
    Route::group([/*'middleware' => ['role:admin|superadmin|clerk, guard:employee']*/], function () {
            ...
            Route::namespace('Transactions')->group(function () {
                ...
                Route::any('transactions.add', 'TransactionController@add')->name('transactions.add');
            });
...
Route::namespace('Front')->group(function () {
    ...
    Route::post('/bank/charge', 'BankController@charge')->name('chargeyekpay');
...
Route::group([/*'middleware' => ['auth', 'web']*/], function () {
    ...
    Route::get('cart/view', 'CartController@show')->name('cart.view');
