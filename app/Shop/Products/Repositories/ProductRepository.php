...
class ProductRepository extends BaseRepository implements ProductRepositoryInterface
{
    ...
    {
        return $this->model->where('status', 1)->with('categories')->orderBy('work_amount', 'desc')->limit($count)->get();
    }
    ...
    {
        return $this->model->where('status', 1)->with('categories')->orderBy('sale_count', 'desc')->limit($count)->get();
    }
    ...
    {
        return $this->model->where('status', 1)->with('categories')->orderBy('created_at', 'desc')->limit($count)->get();
    }
