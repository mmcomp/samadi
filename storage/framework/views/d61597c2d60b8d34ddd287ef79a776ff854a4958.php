            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="/storage/<?php echo e($user->image_path); ?>" class="user-image" alt="User Image">
                        <?php else: ?>
                        <img src="<?php echo e(asset('img/user2-160x160.jpg')); ?>" class="user-image" alt="User Image">
                        <?php endif; ?>
                        <span class="hidden-xs"><?php echo e($user->name); ?> <?php echo e($user->sir_name); ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            ...
                            <p>
                                <?php echo e($user->name); ?> <?php echo e($user->sir_name); ?>
                        ...
                        <li class="user-footer">
                            <!-- <div class="pull-left">
                                <a href="<?php echo e(route('admin.employee.profile', $user->id)); ?>" class="btn btn-default btn-flat">Profile</a>
                            </div> -->
