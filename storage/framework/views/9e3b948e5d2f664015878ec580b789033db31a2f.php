            ...
            <header class="art-header">
                ...
                <div class="art-shapes">
                    ...
                    <div style="z-index: 99999;" id="navbar">
                        <a href="/home"><?php echo e(__('app.home')); ?></a>
                        <a href="#"><?php echo e(__('app.samples')); ?></a>
                        <a href="#"><?php echo e(__('app.products')); ?></a>
                        <a href="#"><?php echo e(__('app.lesson')); ?></a>
                        <a href="/about"><?php echo e(__('app.aboutus')); ?></a>
                        <a href="/contact"><?php echo e(__('app.contactus')); ?></a>
                        <a href="/privacy"><?php echo e(__('app.privacy')); ?></a>
                        <?php if(auth()->check()): ?>
                        <a href="/admin"><?php echo e(__('app.profile')); ?></a>
                        <a href="<?php echo e(route('admin.logout')); ?>"><?php echo e(__('app.exit')); ?></a>
                        <?php else: ?>
                        <a href="/admin/login"><?php echo e(__('app.login')); ?></a>
                        <a href="/register"><?php echo e(__('main.register')); ?></a>
                        <?php endif; ?>
                    </div>
        ...
        <footer class="art-footer">
            <div class="art-footer-inner">
                    ...
                    <div class="art-content-layout">
                        <div class="art-content-layout-row">
                            <div class="art-layout-cell layout-item-1" style="width: 20%">
                                <h3 style="text-align: center;"><span style="color: #BE996A;"><?php echo e(__('app.links')); ?></span></h3>
                                <p><span style="color: #BE996A;"><br></span></p>
                                <p style="text-align: center;"><span style="color: #FFFFFF;"><?php echo e(__('app.samples')); ?></span></p>
                                <p style="text-align: center;"><span style="color: #FFFFFF;"><?php echo e(__('app.contactus')); ?></span></p>
                                <p style="text-align: center;"><?php echo e(__('app.aboutus')); ?><span style="color: #FFFFFF;"><br></span></p>
                                <p style="text-align: center;"><?php echo e(__('app.lesson')); ?></p>
                                <p style="text-align: center;"><span style="color: #FFFFFF;"><?php echo e(__('app.faq')); ?></span></p>
                                <p style="text-align: center;"><span style="color: #FFFFFF;"><a href="/login"><?php echo e(__('main.login')); ?></a></span></p>
                                <p style="text-align: center;"><span style="color: #FFFFFF;"><a href="/register"><?php echo e(__('main.register')); ?></a></span></p>
                            ...
                            <div class="art-layout-cell layout-item-2" style="width: 20%">
                                <p style="text-align: center;"><span
                                        style="color: rgb(190, 153, 106); font-size: 15px; font-weight: bold;"><?php echo e(__('app.social_nets')); ?></span></p>
                                <p style="text-align: center;"><span
                                        style="color: rgb(190, 153, 106); font-size: 15px; font-weight: bold;"><br></span>
                                </p>
                                <p style="text-align: center;"><?php echo e(__('app.instagram')); ?></p>
                                <p style="text-align: center;"><?php echo e(__('app.whatsapp')); ?><br></p>
                                <p style="text-align: center;"><?php echo e(__('app.telegram')); ?></p>
                                <p style="text-align: center;"><?php echo e(__('app.soroush')); ?></p>
                                <p style="text-align: center;"><?php echo e(__('app.pintrest')); ?></p>
                                <p style="text-align: center;"><?php echo e(__('app.facebook')); ?></p>
                                <p style="text-align: center;"><?php echo e(__('app.twitter')); ?></p>
                                <h3></h3>
                                <ul>
                                    <li><a href="#"></a></li>
                                </ul>
                            ...
                            <div class="art-layout-cell layout-item-2" style="width: 25%">
                                <h3 style="text-align: center;"><span
                                        style="color: rgb(190, 153, 106);"><?php echo e(__('app.products')); ?></span><br></h3>
                            ...
                            <div class="art-layout-cell layout-item-3" style="width: 35%">
                                <h3 style="text-align: center;"><span style="color: rgb(190, 153, 106);"><?php echo e(__('app.news')); ?></span><br></h3>
                                <p><span style="color: rgb(190, 153, 106);"><br></span></p>
                ...
                <div class="art-content-layout layout-item-4">
                    <div style="vertical-align: middle:" class="art-content-layout-row">
                        <div class="art-layout-cell layout-item-5" style="width: 50%">
                            <p style="text-align: center;"><span
                                    style="font-family: iranyekan;font-size:large;color: #BE996A;"><?php echo e(__('app.copyright')); ?></span><span
                ...
                <p class="art-page-footer">
                    <span id="art-footnote-links" style="color:#646464;font-family: iranyekan;font-size:medium ;"><?php echo e(__('app.develop')); ?><a style="color: #646464;font-family: iranyekan;font-size:medium ;"
                            href="http://pdr.co.ir/" target="_blank"><?php echo e(__('app.pdco')); ?></a></span>
                </p>
            </div>
        </footer>
