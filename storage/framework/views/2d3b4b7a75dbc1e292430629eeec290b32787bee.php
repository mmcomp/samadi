			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				...
				<form class="login100-form validate-form" method="POST" action="<?php echo e(route('register')); ?>">
					...
					<div  style="text-align: right;font-family: b yekan;" class="wrap-input100 validate-input m-b-23" data-validate = "Name is reauired">
						<span style="text-align: right;font-family: b yekan;" class="label-input100"><?php echo e(__('main.name')); ?></span>
					...
					<div  style="text-align: right;font-family: b yekan;" class="wrap-input100 validate-input m-b-23" data-validate = "SirName is reauired">
						<span style="text-align: right;font-family: b yekan;" class="label-input100"><?php echo e(__('main.sirname')); ?></span>
					...
					<div  style="text-align: right;font-family: b yekan;" class="wrap-input100 validate-input m-b-23" data-validate = "Email is reauired">
						<span style="text-align: right;font-family: b yekan;" class="label-input100"></span><?php echo e(__('main.username_must_be_email')); ?></span>
					...
					<div  style="text-align: right;font-family: b yekan;" class="wrap-input100 validate-input" data-validate="Password is required">
						<span style="text-align: right;font-family: b yekan;" class="label-input100"><?php echo e(__('main.password')); ?></span>
					...
					<div  style="text-align: right;font-family: b yekan;" class="wrap-input100 validate-input" data-validate="Password Confirm is required">
						<span style="text-align: right;font-family: b yekan;" class="label-input100"><?php echo e(__('main.confirm_password')); ?></span>
					...
					<div  style="text-align: right;font-family: b yekan;" class="wrap-input100 validate-input m-b-23" data-validate = "Mobile is reauired">
						<span style="text-align: right;font-family: b yekan;" class="label-input100"></span><?php echo e(__('main.mobile')); ?></span>
					...
					<div style="text-align: right;font-family: b yekan;direction: rtl;" class="text-right p-t-8 p-b-31">
						<input style="text-align: right;font-family: b yekan;height: 25px;width: 25px;float: right;" class="input100" type="checkbox" name="conditions" id="conditions" placeholder="Conditions"><a style="padding-right: 10px; color:red;font-family: b yekan;" href="#"><?php echo e(__('main.accept_roles')); ?></a>
					</div>
