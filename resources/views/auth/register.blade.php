		...
		<div class="container-login100" style="background-image: url('images/bg-profile.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" method="POST" action="{{ route('register') }}">
					...
					<div  style="text-align: right;font-family: iranyekan;" class="wrap-input100 validate-input m-b-23" data-validate = "Username is reauired">
						<span style="text-align: right;font-family: iranyekan;" class="label-input100">{{__('main.sirname')}}</span>
						<input class="input100" type="text" name="sir_name" placeholder="Type your Family">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
					<div  style="text-align: right;font-family: iranyekan;" class="wrap-input100 validate-input m-b-23" data-validate = "Username is reauired">
						<span style="text-align: right;font-family: iranyekan;" class="label-input100"></span>{{__('main.username_must_be_email')}}</span>
					...
					<div  style="text-align: right;font-family: iranyekan;" class="wrap-input100 validate-input" data-validate="Password is required">
						<span style="text-align: right;font-family: iranyekan;" class="label-input100">{{__('main.password')}}</span>
						<input class="input100" type="password" name="password" placeholder="Type your password">
						<span class="focus-input100" data-symbol="&#xf190;"></span>
					</div><br>
					<div  style="text-align: right;font-family: iranyekan;" class="wrap-input100 validate-input" data-validate="Password is required">
						<span style="text-align: right;font-family: iranyekan;" class="label-input100">{{__('main.confirm_password')}}</span>
						<input class="input100" type="password" name="password_confirmation" placeholder="Repeat your password">
						<span class="focus-input100" data-symbol="&#xf190;"></span>
					</div><br>
					<div  style="text-align: right;font-family: iranyekan;" class="wrap-input100 validate-input m-b-23" data-validate = "Username is reauired">
						<span style="text-align: right;font-family: iranyekan;" class="label-input100"></span>{{__('main.mobile')}}</span>
