...
<div class="art-layout-cell art-sidebar1">
  ...
  <div class="art-block clearfix">
    <div class="art-blockheader">
      <h3 class="t">نام و امتیاز طراح</h3>
    </div>
    <div class="art-blockcontent">
      <hr>
      <p style="text-align: center;"><img width="119" height="119"
          style="border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px;"
          alt="" class="art-lightbox" src="/images/Hamed-Akhtari.jpg"><span
          style="font-size: 20px; color: #43686B;"><br></span></p>
      <p style="text-align: center;"><span style="color: rgb(67, 104, 107); font-size: 15px;">محمد
          صمدی</span></p>
      <p style="text-align: center;"><img width="120" height="32"
          style="border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px;"
          alt="" class="art-lightbox" src="/images/5-stars.png"><span
          style="color: #C70A14; font-size: 48px;"><br></span></p>
    </div>
  </div>
</div>
      ...
      <div class="art-content-layout layout-item-0">
        <div class="art-content-layout-row">
          <div class="art-layout-cell layout-item-1" style="width: 100%">
            <p style="text-align: center;border-radius: 10px;"><img width="90%" height="300px" alt=""
                class="art-lightbox" src="/images/x.jpg"
                style="border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px;"><br>
            </p>
          </div>
        </div>
      </div>
      <div class="art-content-layout layout-item-0">
        <div class="art-content-layout-row">
          <div class="art-layout-cell layout-item-2" style="width: 100%">
            <p style="text-align: center;"><img width="78" height="79" alt="" class="art-lightbox"
                src="/images/75f2fb3f-8631-4716-acf3-70cffdacb232.jpg">&nbsp; &nbsp;&nbsp;<img width="78" height="79"
                alt="" class="art-lightbox" src="/images/75f2fb3f-8631-4716-acf3-70cffdacb232.jpg">&nbsp;&nbsp;
              &nbsp;<img width="78" height="79" alt="" class="art-lightbox"
                src="/images/75f2fb3f-8631-4716-acf3-70cffdacb232.jpg">&nbsp;&nbsp;&nbsp;&nbsp;<img width="20"
                height="39" alt="" class="art-lightbox" src="/images/arrow-left.png"
                style="margin-top: 15px; float: left;"><img width="78" height="79" alt="" class="art-lightbox"
                src="/images/75f2fb3f-8631-4716-acf3-70cffdacb232.jpg"><img width="20" height="39" alt=""
                class="art-lightbox" src="/images/arrow-right-01-512.png" style="margin-top: 15px; float: right;">&nbsp;
              &nbsp;&nbsp;<img width="78" height="79" alt="" class="art-lightbox"
                src="/images/75f2fb3f-8631-4716-acf3-70cffdacb232.jpg"></p>
          </div>
        </div>
      </div>
      <div class="art-content-layout layout-item-0">
        <div class="art-content-layout-row">
          <div class="art-layout-cell layout-item-3" style="width: 100%">
            <h1 itemprop="name"
              style="box-sizing: border-box; margin-bottom: 0.5rem; font-weight: 500; line-height: 1.2; color: rgb(51, 51, 51); -webkit-font-smoothing: antialiased;">
              <span style="color: rgb(213, 11, 21); font-family: IRANYekan; line-height: 19px;"><span
                  style="font-size: 18px; color: #000000;">نام محصول :</span> <span style="font-size: 20px;">حلقه
                  ست</span></span><br></h1>
            <p><span style="color: rgb(61, 160, 28); font-family: IRANYekan; font-size: 16px; line-height: 19px;">ویژگی
                های محصول :</span><br></p>
        ...
        <div class="art-content-layout layout-item-0">
          <div class="art-content-layout-row">
            <div class="art-layout-cell layout-item-5" style="width: 100%">
              <p style="text-align: right;"><span style="color: rgb(170, 14, 167); font-size: 16px;">خریداران این محصول،
                  محصولات زیر را هم
                  خریده‌اند</span></p>
              <p style="text-align: center;"><span style="font-size: 20px; color: #D50B15;"></span></p>
            </div>
            ...
            <div class="art-layout-cell layout-item-7" style="width: 100%">
              <p style="text-align: center;"><img width="78" height="79" alt="" class="art-lightbox"
                ...
                &nbsp;<img width="78" height="79" alt="" class="art-lightbox"
                  src="/images/75f2fb3f-8631-4716-acf3-70cffdacb232.jpg">&nbsp;&nbsp;&nbsp;&nbsp;<img width="20"
                  height="39" alt="" class="art-lightbox" src="/images/arrow-left.png"
                  style="float: left; margin-top: 15px;"><img width="78" height="79" alt="" class="art-lightbox"
                  src="/images/75f2fb3f-8631-4716-acf3-70cffdacb232.jpg"><img width="20" height="39" alt=""
                  class="art-lightbox" src="/images/arrow-right-01-512.png"
                  style="float: right; margin-top: 15px;">&nbsp; &nbsp;&nbsp;<img width="78" height="79" alt=""
                  class="art-lightbox" src="/images/75f2fb3f-8631-4716-acf3-70cffdacb232.jpg"></p>
              <p style="text-align: center;">&nbsp;گوشواره عقیقی &nbsp; &nbsp;گوشواره عقیقی &nbsp;
                &nbsp;گوشواره عقیقی &nbsp; &nbsp;گوشواره عقیقی &nbsp; &nbsp;گوشواره عقیقی&nbsp;</p>
            </div>
          </div>
        </div>
      </div>
...
<div class="art-layout-cell art-sidebar2">
  <div class="art-block clearfix">
    <div class="art-blockheader">
      <h3 class="t">جدیدترین محصولات</h3>
    </div>
    <div class="art-blockcontent">
      <p><img width="75" height="73" style="float: right; margin-top: 11px; margin-left: 4px;" alt=""
          class="art-lightbox" src="/images/70b78f57-c2b3-4688-a334-a34ba0e4bfef.jpg"></p>
      <p><span style="color: rgb(38, 38, 38); font-size: 1px;">ز</span></p>
      <p><span style="color: #262626;">فیوژن گوشواره و مدال</span> / <span style="color: #A26907;">دسته :
          گوشواره</span><br></p>
    ...
    <div class="art-blockcontent">
      ...
      <div style="padding-right: 25px; text-align: right;">
        ...
        <p style="text-align: right;"><span
            style="box-sizing: border-box; -webkit-font-smoothing: antialiased; color: rgb(67, 104, 107);"><span
              style="font-weight: bold; font-family: IRANYekan; text-decoration: underline;"><img width="30" height="30"
                style="float: right; margin-top: 0px; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px;"
                alt="" class="art-lightbox" src="/images/gold-ring-with-diamonds.png"></span><span
              style="font-family: IRANYekan;"><a href="#" style="text-decoration: underline; font-size: 14px; "><span
                  style="color: rgb(0, 0, 0); padding-right: 20px; ">انگشتر</span></a><span
                style="font-size: 14px; box-sizing: border-box; text-decoration: underline; font-weight: bold;"></span></span></span>
        </p>
        <hr
        ...
        <span
          style="box-sizing: border-box; -webkit-font-smoothing: antialiased; color: rgb(67, 104, 107); font-weight: bold;"><span
            style="text-decoration: underline;"><img width="30" height="30" alt="" class="art-lightbox"
              src="/images/gold-ring-with-diamonds.png"
              style="border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; float: right;"></span><i
            class="fa fa-circle-o"
            style="font-family: IRANYekan; box-sizing: border-box; display: inline-block; font: normal normal normal 10px/1 FontAwesome; color: red;"><a
              href="#" style="text-decoration: underline; font-size: 14px; "><span
                style="color: rgb(0, 0, 0); padding-right: 20px; ">گردنبند</span></a></i><span
            style="font-size: 14px; box-sizing: border-box; text-decoration: underline; font-family: IRANYekan;"></span></span>
        <hr
          style="margin-top: 5px; margin-bottom: 5px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-top-color: #DDDDDD; border-right-color: #DDDDDD; border-bottom-color: #DDDDDD; border-left-color: #DDDDDD; border-top-style: solid; -webkit-font-smoothing: antialiased; color: black;">
